    ...
    public class CourseInformationActivity extends AppCompatActivity {
        ...
        public void registerOnClick(View view) {
            if (keyStudentID == "3") {
                ...
                if ((courses != null) && (!courses.get(0).toString().equals(""))) {
                    ...
                    courseRegistration.registrationHandler(courses, waitListCourses, courseInfoMap, scheduleMap, courseToRegister,
                                                keyStudentID, seatAvailability, waitListAvailability, this);
                } else {
        ...
        public void chkAndUpdateRegisterButton () {
            ...
            } else btnRegister.setText(R.string.Register);
